...
public class UserDaoUsingJdbcHelper implements UserDao {
    ...
    public UserDaoUsingJdbcHelper() {
        ...
        this.jdbcHelper = new JdbcHelper(ds);
    }
    ...
    public List<User> listUsers(int count, int page) {
        ...
        return jdbcHelper.list(LIST_USERS, (ResultSet rs) -> {
            User user = new User();
    ...
    public User getUser(int userId) {
        return jdbcHelper.get(GET_USER, new ResultMapper<User>() {
